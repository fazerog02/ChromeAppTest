...
apple_list = []
for i in range(3):
    x = randint(0, screen_yokohaba) - fruit_size[0]/2
    y = -fruit_size[1]/2
    speed = randint(2, 4)
    apple_list.append([x, y, speed])
banana_list = []
for i in range(3):
    x = randint(0, screen_yokohaba) - fruit_size[0]/2
    y = -fruit_size[1]/2
    speed = randint(2, 4)
    banana_list.append([x, y, speed])
...
while True:
    ...
    for apple in apple_list:
        ...
        if box_basyo[0] <= apple[0] <= box_basyo[0]+box_size[0] and box_basyo[1] <= apple[1] <= box_basyo[1]+box_size[1]:
            apple_score += 1
    ...
    for banana in banana_list:
        ...
        if box_basyo[0] <= banana[0] <= box_basyo[0]+box_size[0] and box_basyo[1] <= banana[1] <= box_basyo[1]+box_size[1]:
            banana_score += 1
